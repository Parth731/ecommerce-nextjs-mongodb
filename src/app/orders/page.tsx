...
import { getAllOrdersForUserDataType } from "@/types/type";
              ...
              <div className="flow-root">
                {allOrdersForUser && allOrdersForUser.length ? (
                  <ul className="flex flex-col gap-4">
                    {allOrdersForUser.map(
                      (item: getAllOrdersForUserDataType) => (
                        <li
                          key={item._id}
                          className="bg-gray-200 shadow p-5 flex flex-col space-y-3 py-6 text-left text-black"
                        >
                          <div className="flex">
