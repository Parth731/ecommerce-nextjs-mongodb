    ...
    if (res.success) {
      ...
      setAllOrdersForAllUsers(
        res.data && res.data.length
          ? res.data.filter((item: any) => item?.user !== user._id)
          : []
      );
      console.log(res.data, allOrdersForAllUsers);
    } else {
      setPageLevelLoader(false);
    }
  }

  console.log(allOrdersForAllUsers.length);
                  ...
                  {allOrdersForAllUsers.map((item: any) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        {item.orderItems.map(
                          (orderItem: orderItemsType, index: number) => (
